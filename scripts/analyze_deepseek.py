...
def build_prompt(item: dict[str, Any]) -> list[dict[str, str]]:
    ...
    system_prompt = (
        ...
        "请像材料研发人员写判断，不要像媒体摘要，不要写空话，不要中英混排。正文必须使用中文。"
        "分析时必须回答：1. 这是什么技术动向？2. 它可能牵引哪些材料需求？"
        "3. 这些材料是否接近可验证？4. 对材料科室建议采取什么动作？"
        "优先识别新材料、新工艺、新应用场景、企业验证、送样、量产、供应商扩产、专利、论文、标准、路线图、白皮书。"
        "对泛科技新闻、纯融资、纯销量、纯人事、营销稿、无技术细节内容必须降低 material_opportunity_score，并说明暂不优先。"
    ...
    user_prompt = {
        ...
        "required_output_schema": {
            ...
            "material_opportunity": "材料机会层判断，必须明确列出可能值得关注的材料或工艺，如 PEEK、PPS、碳纤维复材、固态电解质、燃料电池材料、导热界面材料、柔性传感材料、表面涂层、回收材料；如果没有机会，写“材料相关性较弱，暂不优先。”",
        ...
        "quality_rules": {
            "high_material_value": "含明确材料、工艺、验证、量产、供应商、专利、论文、标准、路线图或可导入场景。",
            "low_material_value": "泛科技、融资、人事、销量、营销稿、无技术细节、无材料需求牵引。",
            "writing_style": "像材料研发晨会判断，直接说明变化、意义和材料机会；不要写成普通新闻摘要。",
        },
        "priority_rules": {
